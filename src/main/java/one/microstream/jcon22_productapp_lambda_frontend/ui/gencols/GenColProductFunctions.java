...
package one.microstream.jcon22_productapp_lambda_frontend.ui.gencols;
...
import one.microstream.jcon22_productapp_lambda_frontend.ui.ViewPopupProduct;
import one.microstream.jcon22_productapp_lambda_frontend.ui.ViewProducts;
...
public class GenColProductFunctions extends HorizontalLayout implements RenderedComponent<Product>
{
	...
	{
		DAOProducts.deleteProduct(this.value);
